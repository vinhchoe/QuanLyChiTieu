	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Báo Cáo Chi Phí Theo Ngày</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Báo Cáo Chi Phí Theo Ngày</div>
...
?>
<h5 align="center" style="color:blue"> Báo cáo chi phí theo ngày tháng <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
